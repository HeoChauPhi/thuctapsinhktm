...
require_once 'option-themes/data_sources.php';
...
// options
//$tmpl_opt  = get_template_directory() . '/custom/option-framework/admin/option/option.php';
$tmpl_opt  = get_template_directory() . '/custom/option-framework/option-themes/theme-option.php';

// metaboxes
$tmpl_mb1  = get_template_directory() . '/custom/option-framework/admin/metabox/sample_1.php';
$tmpl_mb2  = get_template_directory() . '/custom/option-framework/admin/metabox/sample_2.php';
$tmpl_mb3  = get_template_directory() . '/custom/option-framework/admin/metabox/sample_3.php';
$tmpl_mb4  = get_template_directory() . '/custom/option-framework/admin/metabox/sample_4.php';
$tmpl_mb5  = get_template_directory() . '/custom/option-framework/admin/metabox/sample_5.php';
$tmpl_mb6  = get_template_directory() . '/admin/metabox/sample_6.php';
$tmpl_mb6  = get_template_directory() . '/custom/option-framework/admin/metabox/sample_6.php';
$tmpl_mb7  = get_template_directory() . '/custom/option-framework/admin/metabox/sample_7.php';
$tmpl_mb8  = get_template_directory() . '/custom/option-framework/admin/metabox/sample_8.php';

// shortocode generators
$tmpl_sg1  = get_template_directory() . '/custom/option-framework/admin/shortcode_generator/shortcodes1.php';
$tmpl_sg2  = get_template_directory() . '/custom/option-framework/admin/shortcode_generator/shortcodes2.php';
...
$tmpl_sg2 = array(
	...
	'main_image'     => get_template_directory_uri() . '/custom/option-framework/public/img/vp_shortcode_icon.png',
	'sprite_image'   => get_template_directory_uri() . '/custom/option-framework/public/img/vp_shortcode_icon_sprite.png',
);
