...
{
	?>
	<iframe id="<?php echo uniqid('cpdmap_') ?>" class="cpdmap-frontend" style="width:<?php echo $width ?>px;height:<?php echo $height ?>px;border:none"
		src="<?php echo $this->dir ?>/map/map.php?map=<?php echo $what ?>">
	</iframe>
	<?php	
}
