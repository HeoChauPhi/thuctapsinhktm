# [started](http://started.com)

Powerful shell for rapidly deploying your WordPress projects.

* Project: [github.com/toddmotto/started](https://github.com/toddmotto/started)
* Website: [started.com](http://started.com)
* Twitter: [@started](http://twitter.com/started)
...
Download the latest version from [started.com](http://started.com)

## Get involved! Make started better

There are a few ways to get involved, submit a Pull Request, or submit a comment on the website - [started.com](http://started.com)

## Features

### started
* Basic Semantic started Markup
* W3C Valid Code Foundations
* Responsive Ready, ViewPort meta data
* HTML Class support for IE7, IE8, IE9 Conditionals (started Boilerplate)
* Clean, neatly organised code, with PHP annotations

### jQuery + JavaScript
* Replaced built-in WordPress enqueue with Google CDN
* Protocol relative jQuery if Google CDN offline (started Boilerplate)
* Conditionizr for cross-platform/device detects and enhancements
* Modernizr feature detection, started element support for legacy, progressive enhancement (started Boilerplate)
* DOM Ready JavaScript file setup (scripts.js) for instant JavaScript development
* JavaScript files enqueued using WordPress functions into wp_head

### CSS3
* started Boilerplate reset
* Media Queries framework for instant development using @media
* @font-face empty framework with Fonts folder setup ready for new custom fonts
* CSS3 custom selection styles
* Inline print styles (started Boilerplate)
...
* Optimised Google Analytics in footer (started Boilerplate)
